...
\noindent{{\bf Computer Sciences Department, UW-Madison} \hfill \textit{2015-Present} } \newline
...
\noindent{{\bf American Family Insurance} \hfill \textit{Madison, WI \ 2021-2022} } \newline
...
\noindent{{\bf Continental Automotive Systems} \hfill \textit{Deer Park, IL \ Summer 2013} } \newline
...
\noindent{{\bf ChalkTalkSPORTS} \hfill \textit{Norwalk, CT \ Summer 2011} } \newline
...
\noindent Programming Languages: Python (Tensorflow, PyTorch), R, C++, MATLAB, Julia, HTML/JavaScript

\noindent Document Generation: \LaTeX, Keynote, MS Office Suite
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
